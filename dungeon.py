...
class Dungeon:
    ...
    def vision_potion(self, player_row, player_col):
        ...
        if (0 < vision_rooms_row < self.rows - 1) and (0 < vision_rooms_col < self.cols - 1):
        ...
        elif (vision_rooms_row == 0 or vision_rooms_row == self.rows - 1) or \
                (vision_rooms_col == 0 or vision_rooms_col == self.cols - 1):
            # dungeon corner cases
            if (vision_rooms_row == 0 or vision_rooms_row == self.rows - 1) and \
                    (vision_rooms_col == 0 or vision_rooms_col == self.cols - 1):
